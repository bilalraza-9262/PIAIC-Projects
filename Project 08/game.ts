...
let opponentHealth: number = 100;
let healthDrop: number = 3;
const oppositeTeam: string[] = ["Skeleton", "Zombie", "Warrior", "Assassin"]
const userOption: string[] = ["Attack", "Drink Health", "Quit"]
