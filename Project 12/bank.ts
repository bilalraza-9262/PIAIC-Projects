...
async function getUserDetails() {
    ...
    let userInput: Details = await inquirer.prompt([
        {
            name: "username",
            type: "input",
...
async function main() {
    ...
    const customer_class: Customer = new Customer(callFunction.username, callFunction.usergender, callFunction.usernumber, callFunction.userBalance)
...
class Customer {
    ...
    constructor(name: string, gender: string[], phone: number, balance: number) {
        this._name = name
        this._gender = gender
        this._phone = phone
